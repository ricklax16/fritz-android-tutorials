...
public class TensorFlowImageClassifier implements Classifier {
    ...
    public static Classifier create(
        ...
        modelManager.loadModel(new ModelReadyListener() {
            ...
            public void onModelReady(FritzOnDeviceModel onDeviceModel) {
                c.fritzInterpreter = new FritzTFMobileInterpreter(onDeviceModel);
            }
        });
    ...
    public List<Recognition> recognizeImage(final Bitmap bitmap) {
        if (fritzInterpreter == null) {
            Log.d(TAG, "Model is not ready.");
            return new ArrayList<>();
        }

        if (outputs == null) {
            final Operation operation = fritzInterpreter.getInterpreter().graphOperation(outputName);
