...
import ai.fritz.app.env.ImageUtils;
import ai.fritz.app.fragments.CameraConnectionFragment;
import ai.fritz.app.fragments.LegacyCameraConnectionFragment;
import ai.fritz.app.ui.OverlayView;

public abstract class DetectorCameraBaseActivity extends Activity
    ...
    private void requestPermission() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            if (shouldShowRequestPermissionRationale(PERMISSION_CAMERA) ||
                ...
                Toast.makeText(DetectorCameraBaseActivity.this,
